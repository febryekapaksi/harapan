                ...
                <tbody>
                    <?php foreach ($sales as $s): ?>
                        <tr>
                            ...
                            foreach ($bulan as $b):
                                $bln_no = $b['bulan_no'];
                                $is_future = ($tahun_pilih == $tahun_sekarang && $bln_no > $bulan_sekarang) || ($tahun_pilih > $tahun_sekarang);
                                if ($is_future): ?>
                                    <td class="text-center text-muted">-</td>
                                <?php continue;
                                endif;
                                $val = $realisasi[$s['id']][$bln_no]['total_piutang'] ?? 0;
                                $t_piutang += $val;
                                ?>
                                <td class="text-right">
                        ...
                        <tr>
                            ...
                            <?php foreach ($bulan as $b):
                                ...
                                $is_future = ($tahun_pilih == $tahun_sekarang && $bln_no > $bulan_sekarang) || ($tahun_pilih > $tahun_sekarang);
                                if ($is_future): ?>
                                    <td class="text-center text-muted bg-info">-</td>
                                <?php continue;
                                endif;
                                $p_late = $target[$s['id']][$bln_no]['late_p'] ?? 0;
                                ?>
                        ...
                        <tr style="background-color: #FFFF99;">
                            ...
                            foreach ($bulan as $b):
                                ...
                                $is_future = ($tahun_pilih == $tahun_sekarang && $bln_no > $bulan_sekarang) || ($tahun_pilih > $tahun_sekarang);
                                if ($is_future): ?>
                                    <td class="text-center text-muted" style="background-color: #FFFF99;">-</td>
                                <?php continue;
                                endif;
                                $piutang_bln = (float)($realisasi[$s['id']][$bln_no]['total_piutang'] ?? 0);
                                $p_late = (float)($target[$s['id']][$bln_no]['late_p'] ?? 0);
                        ...
                        <tr style="background-color: #FFFF99;">
                            ...
                            foreach ($bulan as $b):
                                ...
                                $val = $realisasi[$s['id']][$bln_no]['aging_15_30'] ?? 0;
                                $t_1530 += $val;
                                ?>
                        ...
                        <tr>
                            ...
                            <?php foreach ($bulan as $b):
                                ...
                                $piutang_bln = (float)($realisasi[$s['id']][$bln_no]['total_piutang'] ?? 0);
                                $aging_late = (float)($realisasi[$s['id']][$bln_no]['aging_15_30'] ?? 0);
                        ...
                        <tr>
                            ...
                            <?php foreach ($bulan as $b):
                                ...
                                $p_bad = $target[$s['id']][$bln_no]['bad_p'] ?? 0;
                                ?>
                        ...
                        <tr style="background-color: #FFFF99;">
                            ...
                            foreach ($bulan as $b):
                                ...
                                $piutang_bln = (float)($realisasi[$s['id']][$bln_no]['total_piutang'] ?? 0);
                                $p_bad = (float)($target[$s['id']][$bln_no]['bad_p'] ?? 0);
                        ...
                        <tr style="background-color: #FFFF99;">
                            ...
                            foreach ($bulan as $b):
                                ...
                                $val = $realisasi[$s['id']][$bln_no]['aging_30_up'] ?? 0;
                                $t_30up += $val;
                                ?>
                                <td class="text-right" style="background-color: #FFFF99;">
                        ...
                        <tr>
                            ...
                            <?php foreach ($bulan as $b):
                                ...
                                $piutang_bln = (float)($realisasi[$s['id']][$bln_no]['total_piutang'] ?? 0);
                                $aging_bad = (float)($realisasi[$s['id']][$bln_no]['aging_30_up'] ?? 0);
