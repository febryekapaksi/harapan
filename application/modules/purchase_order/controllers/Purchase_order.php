	...
	public function edit($no_po)
	{
		...
		$getitemso = $this->db->query("
			SELECT 
				...
				a.qty as qty,
				a.hargasatuan_include as hargasatuan_include,
	...
	public function SaveNew()
	{
		...
		if ($po_pr_depart == '1') {
			$data = [
				...
				'hargatotal'		=> str_replace(',', '', $post['subtotal']),
				'total_barang'		=> str_replace(',', '', $post['subtotal']),
				'diskontotal'		=> str_replace(',', '', $post['diskontotal']),
				'kirim'				=> str_replace(',', '', $post['kirim']),
				'subtotal'			=> str_replace(',', '', $post['totalexppn']),
				'total_dpp'			=> str_replace(',', '', $post['dpp']),
				'total_ppn'			=> str_replace(',', '', $post['ppn']),
				'grandtotal_idr'	=> str_replace(',', '', $post['grand_total']),
				'status'			=> '1',
