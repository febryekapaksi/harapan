...
<script>
    ...
    $(document).on('click', '.detailAjust', function(e) {
        ...
        $("#head_title2").html("<b>PERMINTAAN PENGECEKAN PRODUCT</b>");
        $.ajax({
            type: 'POST',
    ...
    $(document).on('click', '#modalDetail', function(e) {
        ...
        $("#head_title2").html("<b>INCOMING PRODUCT</b>");
        $.ajax({
            url: base_url + active_controller + 'modal_incoming_product',
            type: "POST",
            data: {
        ...
        swal({
            ...
            function(isConfirm) {
                if (isConfirm) {
                    ...
                    $.ajax({
                        url: base_url + active_controller + '/process_in_product',
                        type: "POST",
                        data: formData,
                        cache: false,
                        dataType: 'json',
        ...
        swal({
            ...
            function(isConfirm) {
                if (isConfirm) {
                    ...
                    $.ajax({
                        url: base_url + active_controller + '/move_product',
                        type: "POST",
                        data: formData,
                        cache: false,
                        dataType: 'json',
                        ...
                        success: function(data) {
                            if (data.status == 1) {
                                ...
                                window.location.href = base_url + active_controller + '/product_adjustment';
                            } else if (data.status == 0) {
                                swal({
                                    title: "Save Failed!",
                                    text: data.pesan,
    ...
    function DataTables(no_po = null, gudang = null) {
        var dataTable = $('#example1').DataTable({
            ...
            "ajax": {
                url: base_url + active_controller + '/server_side_incoming_product',
                type: "post",
                data: function(d) {
                    d.no_po = no_po,
                        d.gudang = gudang
