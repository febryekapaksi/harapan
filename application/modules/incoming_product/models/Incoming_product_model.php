<?php
class Incoming_product_model extends BF_Model
{
    ...
    public function get_data_json_incoming_product()
    {
        // $controller			= ucfirst(strtolower($this->uri->segment(1)));
        // $Arr_Akses			= getAcccesmenu($controller);

        $requestData    = $_REQUEST;
        $fetch            = $this->query_data_json_incoming_product(
            $requestData['no_po'],
            $requestData['gudang'],
    ...
    public function query_data_json_incoming_product($no_po, $gudang, $like_value = NULL, $column_order = NULL, $column_dir = NULL, $limit_start = NULL, $limit_length = NULL)
    {
    ...
    public function modal_incoming_product()
    {
        ...
        $this->template->set($data);
        $this->template->render('modal_incoming_product');
    }
