...
<div class="box">
	<div class="box-header">
		<span class="pull-right">
			<?php if ($ENABLE_ADD) : ?>
				<a class="btn btn-success btn-sm" href="<?= base_url('adjustment/add') ?>" title="Add"> <i class="fa fa-plus">&nbsp;</i>Add</a>
			<?php endif; ?>
			<!-- <a class="btn btn-info btn-sm" href="<?= base_url('adjustment/download_excel'); ?>" target='_blank' title="Download"><i class="fa fa-excel">&nbsp;</i>Excel</a> -->
		</span>
			...
			<div class="col-md-5">
				<select name="code_lv4" id="code_lv4" class='form-control select2'>
					...
					foreach ($material as $key => $value) {
						echo "<option value='" . $value['code_lv4'] . "'>" . strtoupper($value['nama']) . "</option>";
					}
					?>
				</select>
			</div>
