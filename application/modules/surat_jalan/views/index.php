...
<div class="box box-primary">
    <div class="box-header">
        <div class="row">
            <div class="col-sm-12">
                <a class="btn btn-primary" href="<?= base_url('surat_jalan/add') ?>"><i class="fa fa-plus"></i>&emsp;Surat Jalan</a>
            </div>
        </div>
        <hr>
...
<script>
    $(document).ready(function() {
        ...
        $('#btnExport').on('click', function(e) {
            ...
            window.location.href = siteurl + 'surat_jalan/export_excel?start_date=' + start + '&end_date=' + end;
        });
    });
