...
class Depresiasi_model extends BF_Model
{
    ...
    // -----------------------------------------------------------------------
    // Ambil data depresiasi untuk dijurnal (join dengan asset_category untuk COA)
    // -----------------------------------------------------------------------
    public function getDepresiasiUntukJurnal($bulan, $tahun, $kdcab = '')
    {
        $where_kdcab = '';
        if (!empty($kdcab)) {
    ...
    // -----------------------------------------------------------------------
    public function getDetailDepresiasi($bulan, $tahun, $kdcab = '')
    {
        $where_kdcab = '';
        if (!empty($kdcab)) {
