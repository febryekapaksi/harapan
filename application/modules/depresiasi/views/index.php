<?php
$ENABLE_ADD    = has_permission('Depresiasi.Add');
$ENABLE_MANAGE = has_permission('Depresiasi.Manage');
$ENABLE_VIEW   = has_permission('Depresiasi.View');
?>
<link rel="stylesheet" href="<?= base_url('assets/plugins/datatables/dataTables.bootstrap.css'); ?>">

<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title"><i class="fa fa-list"></i> Daftar Depresiasi Asset</h3>
        <div class="box-tools pull-right">
            ...
            <?php endif; ?>
            <a href="<?= site_url('depresiasi/log_jurnal') ?>" class="btn btn-default btn-sm">
    ...
    <div class="box-body">
        ...
        <table id="tbl_depresiasi" class="table table-bordered table-striped" width="100%">
            <thead>
                <tr class="bg-blue">
                    ...
                    <th class="text-center">Total Depresiasi</th>
    ...
    <div class="modal-dialog" style="width:85%;">
        <div class="modal-content">
            <div class="modal-header bg-blue">
                ...
                <h4 class="modal-title"><i class="fa fa-list"></i> Detail Asset Depresiasi</h4>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="alert alert-info">
                    ...
                    Anda akan memposting jurnal depresiasi untuk periode
...
<script>
    ...
    function initDataTable() {
        ...
        _dataTable = $('#tbl_depresiasi').DataTable({
            processing: true,
            serverSide: true,
            stateSave: false,
            destroy: true,
    ...
    function renderDetail(data, bulan, tahun) {
        ...
        html += '<thead><tr class="bg-blue">' +
            ...
            '<th>Nilai Perolehan</th><th>Depresiasi/Bln</th>' +
    ...
    $(document).on('click', '.btn-posting', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                html += '<thead><tr class="bg-blue"><th>Kategori</th><th>Cabang</th><th>Jml Asset</th><th>Total Depresiasi</th><th>COA Debit</th><th>COA Kredit</th></tr></thead><tbody>';
                var grouped = {};
                $.each(data, function(i, row) {
    ...
    $(document).on('click', '.btn-batal', function() {
        ...
        swal({
            title: 'Batal Jurnal?',
            text: 'Jurnal depresiasi periode ' + (bulan_nama[bulan] || bulan) + ' ' + tahun + ' akan dihapus dari sistem akuntansi.',
            type: 'warning',
    ...
    $('#btn-proses-otomatis').on('click', function() {
        ...
        swal({
            ...
            text: 'Sistem akan memproses jurnal depresiasi untuk bulan ini secara otomatis.',
            type: 'info',
            showCancelButton: true,
