            ...
            <div class="form-group row">
                <div class="col-md-12">
                    <table class='table table-bordered table-striped'>
                        <thead>
                            <tr class='bg-blue'>
                                <td align='center' style="width: 20%;"><b>Nama Produk</b></td>
                                <td align='center' style="width: 80px"><b>Qty</b></td>
                                <td align='center' style="width: 200px"><b>Harga</b></td>
                                <td align='center' style="width: 80px"><b>Free Stok</b></td>
                                <td align='center' style="width: 80px"><b>Selisih</b></td>
                                <td align='center' style="width: 80px"><b>Propose PR</b></td>
                                <td align='center' style="width: 100px"><b>% Discount</b></td>
                                <td align='center' style="width: 200px"><b>Pengiriman</b></td>
                                <td align='center' style="width: 200px"><b>Total Harga</b></td>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
